  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight text-zinc-900">My Products</h1>
        <p className="text-zinc-500 font-medium">Manage your listed figures and statues.</p>
      </div>
