...
export function ProductsList({ initialProducts }: ProductsListProps) {
  ...
  const handleAddProduct = () => {
    const newProduct: Product = {
      ...
      category_names: [],
      image:
        "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=800&auto=format&fit=crop", // Default placeholder
    };
      ...
      <ScrollReveal delay={100}>
        <div className="flex gap-8 py-6 border-y border-zinc-100 overflow-x-auto scrollbar-hide">
          ...
          <div className="min-w-[120px]">
            ...
            <p className="text-2xl font-bold text-zinc-900">
              {products.filter((p) => p.condition === "New").length} New
            </p>
          </div>
          <div className="w-px bg-zinc-100 shrink-0" />
          <div className="min-w-[120px]">
