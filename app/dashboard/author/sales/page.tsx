...
const MOCK_SALES: ProductSalesData[] = [
  {
    ...
    product: {
      ...
      image:
        "https://images.unsplash.com/photo-1531279554141-7dfdb443c375?q=80&w=800&auto=format&fit=crop",
    },
    totalUnitsSold: 42,
...
export const metadata = {
  ...
  description:
    "Manage your product sales, restock inventory, and update statuses.",
};
