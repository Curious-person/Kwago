        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-8 py-20">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="text-zinc-500 text-lg leading-relaxed max-w-lg">
                  A space dedicated to the intersection of technology,
                  philosophy, and minimalist living.
                </p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <div className="flex flex-col gap-8 text-zinc-600 text-lg leading-relaxed mb-24">
            <ScrollReveal delay={100}>
              <p>
                Hi, I&apos;m the creator behind Journal. This project started as
                a personal quest to find a digital space that didn&apos;t feel
                noisy. In an era of infinite scroll and algorithm-driven feeds,
                I wanted to build a sanctuary for long-form thought and
                systematic observation.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={200}>
              <p>
                With a background in software design and a passion for stoic
                philosophy, I spend my days exploring how we can use modern
                tools to enhance—
                <span className="text-zinc-900 font-medium italic underline decoration-[#0066FF] underline-offset-4">
                  not
                </span>{" "}
                distract from—our human experience. My writing focuses on
                building sustainable habits, the ethics of AI, and the quiet joy
                of craft.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={300}>
              <p>
                When I&apos;m not writing, you&apos;ll likely find me in a local
                coffee shop with a physical notebook, or hiking through the
                nearby pine forests. I believe the best ideas often arrive when
                we step away from the screen.
              </p>
            </ScrollReveal>
          </div>
            ...
            <section className="bg-white border border-zinc-100 rounded-[32px] p-8 md:p-12">
              <div className="max-w-xl">
                ...
                <p className="text-zinc-500 mb-10 leading-relaxed">
                  I&apos;m always open to collaborations or just a friendly chat
