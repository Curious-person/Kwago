    ...
    blocks: [
      {
        ...
        type: "subtitle",
        content:
          "Exploring how physical environments shape our mental clarity and foster deep reflection.",
      },
    ...
    blocks: [
      {
        ...
        type: "subtitle",
        content:
          "How design systems are pivoting from engagement hacking to respecting user attention.",
      },
      {
        id: "b2",
        type: "headline",
        content: "Designing Respectful Interfaces",
      },
      {
        id: "b3",
        type: "body",
      ...
      },
      {
        ...
        type: "quote",
        content:
          "Technology should be like a gentle breeze: felt, but not seen.",
      },
      {
        id: "b5",
        type: "body",
