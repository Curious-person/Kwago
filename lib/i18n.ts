...
const resources = {
  en: {
    translation: {
      ...
      "In the fast-paced world of digital publishing, every post carries weight. Whether it’s a product launch, a thought leadership piece, or a community update, the process of admin pending approval is more than just a technical checkpoint—it’s an art form.": "In the fast-paced world of digital publishing, every post carries weight. Whether it’s a product launch, a thought leadership piece, or a community update, the process of admin pending approval is more than just a technical checkpoint—it’s an art form.",
  ...
  es: {
    translation: {
      ...
      "In the fast-paced world of digital publishing, every post carries weight. Whether it’s a product launch, a thought leadership piece, or a community update, the process of admin pending approval is more than just a technical checkpoint—it’s an art form.": "En el acelerado mundo de la publicación digital, cada publicación tiene peso. Ya sea el lanzamiento de un producto, un artículo de liderazgo intelectual o una actualización de la comunidad, el proceso de aprobación pendiente del administrador es más que un simple punto de control técnico: es una forma de arte.",
