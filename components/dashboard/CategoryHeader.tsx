    ...
    return (
        <>
            <div className="mb-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                {/* Title Section */}
                <div>
                    <h1 className="text-3xl sm:text-4xl font-bold text-zinc-900 mb-2">My Categories</h1>
                    <p className="text-sm sm:text-base text-zinc-600">Organize your products into categories</p>
                </div>
