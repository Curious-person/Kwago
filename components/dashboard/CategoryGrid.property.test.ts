...
describe('CategoryGrid - Property-Based Tests for Responsive Layout', () => {
     ...
     */
    const desktopViewportArbitrary = () =>
     ...
     */
    const calculateGridColumns = (viewportWidth: number, categoryCount: number): number => {
            ...
            fc.assert(
                fc.property(
                    ...
                    (viewportWidth, categoryCount) => {
                        const visibleColumns = calculateGridColumns(viewportWidth, categoryCount);
        ...
        it('should always return valid Tailwind grid class', () => {
            fc.assert(
                fc.property(
                    ...
                    (viewportWidth) => {
                        const gridClass = getTailwindGridClass(viewportWidth);
                        const validClasses = ['grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-3'];
