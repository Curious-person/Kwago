    ...
    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="flex flex-col gap-2">
          ...
          <Input id="name" placeholder="John Doe" className="bg-[#F9FAFB] border-transparent focus:bg-white focus:border-zinc-200 transition-all" />
        </div>
        <div className="flex flex-col gap-2">
          <label htmlFor="email" className="text-xs font-bold uppercase tracking-widest text-zinc-400">Email</label>
          <Input id="email" type="email" placeholder="john@example.com" className="bg-[#F9FAFB] border-transparent focus:bg-white focus:border-zinc-200 transition-all" />
        </div>
      </div>
