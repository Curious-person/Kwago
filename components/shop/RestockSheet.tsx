    ...
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="sm:max-w-md">
        <SheetHeader className="mb-8">
          ...
          <SheetDescription>
            Add more stock for this product. The new stock will be added to the
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-4 p-4 rounded-3xl bg-zinc-50 border border-zinc-100">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-500">
                Current Stock: {item.stockRemaining}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <Input
              ...
              onChange={(e) =>
                setAdditionalStock(parseInt(e.target.value) || 0)
              }
              placeholder="e.g. 5"
            />
          </div>
        ...
        <div className="mt-auto pt-8 border-t border-zinc-100">
          <Button
            onClick={handleSave}
            className="w-full h-14 text-base font-bold bg-[#0066FF] hover:bg-blue-600"
          >
            Confirm Restock
          </Button>
        </div>
