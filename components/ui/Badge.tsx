  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        featured:
          "border-transparent bg-[#E6F0FF] text-[#0066FF] text-[10px] font-bold uppercase tracking-widest px-2.5 py-1",
        category:
          "border-transparent text-[#0066FF] text-xs font-bold uppercase tracking-wider p-0",
      },
    },
    defaultVariants: {
      variant: "default",
